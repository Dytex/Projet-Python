...
from keras import backend as K #permet de configurer plus finement notre framework
K.set_image_data_format( 'channels_last' )

#import librairies utiles

import os  #lire le contenu des répertoires et charger les images
from multiprocessing.dummy import Pool  #faire les prédictions dans un thread séparé et ne pas ralentir la vidéo
#Bonus à voir :
from threading import Thread  #pour lancer l’audio séparément sans bloquer la vidéo ou avoir plusieurs voix en même temps
import win32com.client  #pour récupérer la voix de Windows 

### Step 1 : find face + Step 2 : crop around face
##################################################
def LancementFaceReco():
